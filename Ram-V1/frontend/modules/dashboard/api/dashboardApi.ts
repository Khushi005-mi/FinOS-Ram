...
export const dashboardApi = {
  /**
   * Fetches live summary financial metrics for the active dataset from FastAPI backend.
   */
  ...
  /**
   * Fetches live monthly trend points for the active dataset from FastAPI backend.
   */
  ...
  /**
   * Fetches live COGS cost breakdown for the active dataset from FastAPI backend.
   */
  ...
  /**
   * Fetches live CFO decision recommendations for the active dataset from FastAPI backend.
   */
